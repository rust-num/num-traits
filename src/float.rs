...
impl FloatCore for f16 {
    constant! {
        ...
        neg_zero() -> -0.0;
        min_value() -> f16::MIN;
        min_positive_value() -> f16::MIN_POSITIVE;
        epsilon() -> f16::EPSILON;
        max_value() -> f16::MAX;
    }
...
impl Float for f16 {
    ...
    forward! {
        ...
        libm::truncf16 as trunc(self) -> Self;
        libm::fabsf16 as abs(self) -> Self;
        libm::sqrtf16 as sqrt(self) -> Self;
        libm::copysignf16 as copysign(self, other: Self) -> Self;
    }
...
mod tests {
    ...
    fn total_cmp() {
        ...
        #[cfg(not(target_arch = "x86"))]
        {
            ...
            #[cfg(has_f16)]
            {
                let s_nan = f16::from_bits(0x7d00);
                let q_nan = f16::from_bits(0x7e00);
                check_lt(s_nan, q_nan);

                let neg_s_nan = f16::from_bits(0xfd00);
        ...
        #[cfg(has_f16)]
        {
            ...
            check_lt(f16::INFINITY, f16::NAN);
            check_gt(f16::NAN, 1.0_f16);
        }
    }
}
